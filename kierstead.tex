...
---------------\\
{\footnotesize \indent 1980 Mathematics Subject Classification. Primary 03D45.\\
...
\indent Suppose that after the ith round of play the   $K$-player is confronted with $\meph{\hat{P}}$   in   $L$   and plays   $\meph{P^+}$   in $K_w$, where   $\meph{P^+} = P \cup \{i\}$.   
The   $L$-player should respond with   $\meph{\hat{P}^+}$ as follows.\\
\newline
